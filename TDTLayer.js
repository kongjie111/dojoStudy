        ...
        getTileUrl: function(level, row, col) {
			switch (this.layertype) {
                    case "tdt_vec"://矢量
                        ...
                        break;
                    case "tdt_img"://影像
						url = "http://t0.tianditu.com/img_c/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=img&STYLE=default&TILEMATRIXSET=c&TILEMATRIX="+level+"&TILEROW="+row+"&TILECOL="+col+"&FORMAT=tiles";
                        break;
                    case "tdt_cva"://影像标注
