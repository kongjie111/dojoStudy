define(["dojo/_base/declare", "esri/layers/TiledMapServiceLayer", "esri/geometry/Extent", "esri/SpatialReference", "esri/layers/TileInfo"],
    function (declare, TiledMapServiceLayer, Extent, SpatialReference, TileInfo) {
		return declare("GoogleLayer", TiledMapServiceLayer, { // create WMTSLayer by extending esri.layers.TiledMapServiceLayer  
                layertype:"gg_img",
                ...
                getTileUrl: function(level, row, col){  
					...
					switch (this.layertype) {
						case "gg_img":
							url = "http://mt" + (col % 4) + ".google.cn/vt/lyrs=s@112&hl=zh-CN&gl=cn&" + "x=" + col + "&" +  "y=" +  row +  "&" +  "z=" +  level +  "&s=";  
							break;
						case "gg_cva":
							url = "http://mt" + (col % 4) + ".google.cn/vt/lyrs=h@177000000&hl=zh-CN&gl=cn&" + "x=" + col + "&" +  "y=" +  row +  "&" +  "z=" +  level +  "&s="; 
							break;
						case "gg_vec":
							url = "http://mt" + (col % 4) + ".google.cn/vt/lyrs=m@112&hl=zh-CN&gl=cn&" + "x=" + col + "&" +  "y=" +  row +  "&" +  "z=" +  level +  "&s=";  
							break;
						default:
							url = "http://mt" + (col % 4) + ".google.cn/vt/lyrs=s@112&hl=zh-CN&gl=cn&" + "x=" + col + "&" +  "y=" +  row +  "&" +  "z=" +  level +  "&s=";  
							break;
